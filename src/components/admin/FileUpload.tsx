...
import { Loader2, Upload, X, FileText, Image as ImageIcon, ExternalLink } from 'lucide-react'

type UploadPurpose = 'resume' | 'og'
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div
        ...
        style={{
          background: dragOver ? 'var(--accent-glow)' : 'var(--bg-subtle)',
      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <div
            ...
            style={{
              background: uploadState === 'done' ? 'rgba(34,197,94,0.12)' : 'var(--bg-elevated)',
          ...
          <div className="flex-1 min-w-0">
            {isUploading ? (
              ...
              <>
                <p className="text-sm font-medium" style={{ color: 'var(--text-primary)' }}>
                  {uploadState === 'done' ? 'Uploaded' : 'File set'}
                </p>
                <p className="text-xs mt-0.5 truncate" style={{ color: 'var(--text-tertiary)' }}>
